...
public class Pref {
	...
	public void setTripRunningStatus(boolean tripRunningStatus){
		edit().putBoolean(TRIP_RUNNING_STATUS, tripRunningStatus).commit();
	}
	public boolean getTripRunningStatus(){
		return sharedPreferences.getBoolean(TRIP_RUNNING_STATUS,false);
	}
