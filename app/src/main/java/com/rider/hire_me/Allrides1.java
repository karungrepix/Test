...
import com.ride.adapter.CustomRiderAdapter1;
...
public class Allrides1 extends Activity {
    ListView    listView;
    TextView tv;
    ...
    CustomRiderAdapter1 adapter;
    private List<Movie> movieList = new ArrayList<Movie>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_allrides1);
        ...
        tv=(TextView)findViewById(R.id.listemptyallride);
        adapter = new CustomRiderAdapter1(this, movieList);
    ...
    {
        // userid="55b7ff49230d7621738beb77";


        final String url=Liveurl+"ridehistory?userid="+userid;
        //*******************************************ListView code start*****************************************************
