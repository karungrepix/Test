...
public class FragmentRouteNavigation extends FragmentActivity implements
    ...
    private ImageView driver_call,car_icon;
                    ...
                    if(!isRoute){
                        try{
                         ...
                         //   cardLayout.setVisibility(View.VISIBLE);
                            ...
                            switch (Integer.parseInt(tripHistory.getDriver().getCategory_id())){
                                case 1:
                                    //tvCarName.setText("Hatchback");
                                    car_icon.setImageResource(R.drawable.hatchback_icon);
                                    break;
                                case 2:
                                    //  tvCarName.setText("Sedan");
                                    car_icon.setImageResource(R.drawable.sedan_icon);
                                    break;
                                case 3:
                                    // tvCarName.setText("SUV");
                                    car_icon.setImageResource(R.drawable.suv_icon);
                                    break;
                                case 4:
                                    car_icon.setImageResource(R.drawable.bike_image);
                                    break;
                            }
